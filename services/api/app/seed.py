...
async def seed_fitbox(session: AsyncSession, *, reset: bool = False) -> bool:
    ...
    policy = PolicyDecisionRecord(
        ...
        decision_code="FITBOX_DEMO_APPROVAL_REQUIRED",
        reason_codes=["DEMO_OPERATOR_APPROVAL"],
        reasons=["The seeded FitBox recovery requires an explicit operator approval."],
